...
const sidebarConfig = {
  navMain: [
    ...
    { title: "Generate Blog", url: "/dashboard/create", icon: IconEdit },
    { title: "Your Blogs", url: "/dashboard/blogs", icon: IconNotebook },
    { title: "Publish to WordPress", url: "/dashboard/wordpress", icon: IconUpload },
...
export function AppSidebar(props: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    ...
    >
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            ...
            >
              <Link href="/dashboard" className="flex items-center gap-2">
                <span className="text-xl font-heading tracking-tight">
                  WORDYWRITES
                </span>
              </Link>
            </SidebarMenuButton>
      ...
      <SidebarFooter className="border-t border-border pt-4 mt-4">
