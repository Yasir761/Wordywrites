...
// this code is no-resposive yet with demo placeholder
...
//   { icon: ClipboardCopy, label: "Copy to Clipboard", x: 80, y: 340, delay: 0.2 },
//   { icon: Eye, label: "Content Previews", x: 390, y: 360, delay: 0.3 },
//   { icon: SearchCheck, label: "SEO Analyzer", x: 30, y: 200, delay: 0.4 },
//   { icon: Scan, label: "Crawl & Enhance", x: 310, y: 10, delay: 0.5 },
//   { icon: Repeat, label: "Auto Posting", x: 190, y: 420, delay: 0.6 },
// ]
...
//             transition={{ delay: 0.3 }}
//           >
//             Go beyond generic AI writers. Wordywrites creates full SEO-ready blog drafts, refreshes old posts from just a URL, and publishes directly to WordPress — all in one click.
//           </motion.p>
...
//       <motion.div
//         className="mt-16 w-full max-w-4xl bg-gray-100 rounded-2xl shadow-md p-6 flex items-center justify-center text-gray-500 text-lg font-medium"
...
// this code is resposive yet with demo placeholder
...
//   ...f,
//   x: 40,
//   y: 30 + i * 70, // more spacing for readability on small screens
// }))
...
// const buzzwords = ["SEO-Ready", "Engaging", "Optimized", "Publish-Ready"]
...
//   return (
//     <motion.h1
//       className="font-heading text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 text-center md:text-left leading-snug mb-4"
//       style={{ fontFamily: "var(--font-heading)" }}
//       initial={{ opacity: 0, y: -20 }}
//       animate={{ opacity: 1, y: 0 }}
//       transition={{ delay: 0.2 }}
...
//   return (
//     <motion.div
//       className="absolute bg-white/90 border border-gray-200 backdrop-blur-md shadow-xl rounded-xl px-3 py-2 flex items-center gap-2 text-xs sm:text-sm md:text-base font-medium text-gray-800 z-10"
//       style={{ left: x, top: y }}
//       initial={{ opacity: 0, scale: 0.8, y: 10 }}
//       animate={{ opacity: 1, scale: 1, y: 0 }}
//       transition={{ duration: 0.6, delay }}
...
//     <main
//       id="hero"
//       className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-16 sm:py-20 scroll-mt-28"
//     >
//       <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
//         {/* Left Content */}
//         <div className="space-y-6 text-center md:text-left">
...
//           <motion.p
//             className="text-gray-600 text-sm sm:text-lg md:text-xl font-body max-w-lg sm:max-w-xl mx-auto md:mx-0 leading-relaxed"
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             transition={{ delay: 0.3 }}
//           >
//             Go beyond generic AI writers. Wordywrites creates full SEO-ready blog
//             drafts, refreshes old posts from just a URL, and publishes directly
//             to WordPress — all in one click.
//           </motion.p>
...
//                 <Button
//                   variant="outline"
//                   className="px-6 py-3 text-base sm:text-lg relative overflow-hidden border-2 border-transparent bg-white/80 backdrop-blur-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 transition-all duration-300 hover:scale-105 hover:border-blue-400 shadow-md"
//                 >
//                   Start Free
//                 </Button>
//               </Link>
...
//         {/* Right Floating Features */}
//         <motion.div
//           className="relative h-[320px] sm:h-[400px] md:h-[520px] w-full md:w-[640px] mx-auto"
//           initial={{ opacity: 0, scale: 0.95 }}
//           animate={{ opacity: 1, scale: 1 }}
//           transition={{ duration: 0.8, delay: 0.3 }}
//         >
...
//       {/* Demo / Gif Placeholder */}
//       <motion.div
//         className="mt-12 sm:mt-16 w-full max-w-3xl sm:max-w-4xl bg-gray-100 rounded-2xl shadow-md p-4 sm:p-6 flex items-center justify-center text-gray-500 text-base sm:text-lg font-medium"
//         initial={{ opacity: 0, y: 30 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ delay: 0.8 }}
//       >
...
//       {/* Scroll hint */}
//       <motion.div
//         className="mt-8 text-xs sm:text-sm text-gray-500 flex items-center justify-center gap-2 cursor-pointer hover:text-blue-600 transition"
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
//         transition={{ delay: 0.6 }}
//       >
