      ...
      <div className="border-t border-gray-200 py-12 px-4 sm:px-6 mt-12">
        ...
        <div className="mt-10 flex flex-col items-center gap-4">
          <div className="flex gap-6 text-gray-500">
            <Link href="https://x.com/Mohd_Yasir29" target="_blank" className="hover:text-indigo-600">
              <X className="w-5 h-5" />
            </Link>
            <Link href="https://github.com/Yasir761" target="_blank" className="hover:text-indigo-600">
              <Github className="w-5 h-5" />
            </Link>
            <Link href="https://codilad.dev" target="_blank" className="hover:text-indigo-600">
              <Globe className="w-5 h-5" />
            </Link>
          </div>
          <div className="text-center text-xs text-gray-400">
            &copy; {new Date().getFullYear()} Wordywrites. All rights reserved. <br />
            Found and developed by <span className="font-medium text-gray-600">Mohd Yasir</span>.
          </div>
        </div>
      </div>
