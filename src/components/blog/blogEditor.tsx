...
//       {/* HTML Preview for Devs */}
//       {showHtml && (
//         <pre className="mt-4 p-3 bg-muted text-sm rounded-md overflow-x-auto">
//           {editor.getHTML()}
//         </pre>
//       )}
//     </div>
...
//     immediatelyRender: false,
//     onUpdate: ({ editor }) => {
//       setHtmlContent(editor.getHTML()) // keep HTML synced
//     },
//   })
...
//       {/* HTML Preview for Devs */}
//       {showHtml && (
//         <pre className="mt-4 p-3 bg-muted text-sm rounded-md overflow-x-auto whitespace-pre-wrap">
//           {htmlContent}
//         </pre>
//       )}
//     </div>
...
//           }}
//           className="w-full min-h-[300px] border border-border rounded-md bg-card p-3 font-mono text-sm"
//         />
//       )}
//     </div>
//   )
