...
export default function IntegrationGrid() {
  ...
  return (
    <section
      className="py-24 sm:py-32 px-4 sm:px-6 lg:px-8 scroll-mt-24 bg-gradient-to-b from-white via-indigo-50/20 to-white"
      id="integrations"
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 sm:mt-6 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Go live in seconds with direct WordPress publishing, formatted HTML,
            cloud exports, and more — all from one place.
          </p>
        </motion.div>
          ...
          {integrations.map((integration, i) => {
            ...
            return (
              ...
              >
                {/* Glow */}
                <motion.div
                  className={`absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-br ${integration.bgGradient} opacity-0 ${
                ...
                >
                  {/* Coming soon badge */}
                  {isComingSoon && (
                    <div className="absolute top-4 right-4 text-[10px] px-2 py-1 rounded-full bg-gray-100 border border-gray-300 text-gray-600 font-semibold uppercase tracking-wide">
                      Coming soon
                    </div>
                  )}
                  ...
                  <div className="mb-4 flex-shrink-0">
                    <motion.div
                      ...
                      whileHover={!isComingSoon ? { scale: 1.15, rotate: 6 } : {}}
                  ...
                  <div className="flex-grow flex flex-col gap-3">
                    ...
                    <motion.div
                      ...
                      animate={{
                        opacity:
                          hoveredIndex === i && !isComingSoon ? 1 : 0.6,
                        height:
                          hoveredIndex === i && !isComingSoon
                            ? "auto"
                            : "0px",
                      }}
                    ...
                    >
                      {integration.features.map((feature, j) => (
                        <motion.div
                          ...
                          animate={{
                            opacity:
                              hoveredIndex === i && !isComingSoon ? 1 : 0,
                            x:
                              hoveredIndex === i && !isComingSoon ? 0 : -10,
                          }}
