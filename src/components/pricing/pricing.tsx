...
//     // try {
//     //   // Import and initialize Paddle
//     //   const { Paddle }:any = await import('@paddle/paddle-js');
      
//     //   const paddle = Paddle({
//     //     environment: 'production', // Change to 'production' when ready
//     //     token: process.env.NEXT_PUBLIC_PADDLE_CLIENT_TOKEN, // Replace with your actual client token
//     //   });
...
//     paddle.Checkout.open({
//       items: [{ priceId: "pri_01k3amkh5jpxnsb12by5ae99fw", quantity: 1 }],
//       settings: {
//         displayMode: "overlay",
//         theme: "dark",
//         successUrl: "https://wordywrite.app/success",
//       },
//     });
//   };
