...
//           <p className="text-gray-800 font-medium mb-3">🔒 Upgrade to unlock this feature</p>
//           {/* <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-cyan-600 text-white font-semibold shadow hover:from-purple-700 hover:to-cyan-700">
//             Upgrade Now
//           </button> */}
//         </div>
//       )}
...
//   // simulate user plan (replace with real auth/plan check)
//   const userPlan = "free"; // "starter" or "pro"
...
//                 Your SEO-Optimized Blog is Ready!
//               </h2>
//             </div>

//             {/* Keyword Card (always visible) */}
//             <div className="relative group">
//               <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-2xl blur opacity-20 group-hover:opacity-30 transition duration-300"></div>
//               <div className="relative bg-white p-8 rounded-xl border border-gray-200 shadow-lg">
//                 <div className="flex items-center space-x-3 mb-3">
...
//                 <div className="flex items-center space-x-3 mb-3">
//                   <div className="w-3 h-3 bg-cyan-500 rounded-full"></div>
//                   <h3 className="text-sm font-semibold text-cyan-600 uppercase tracking-wider">
//                     SEO Title
//                   </h3>
//                 </div>
//                 <p className="text-xl font-semibold text-gray-900 leading-relaxed">
