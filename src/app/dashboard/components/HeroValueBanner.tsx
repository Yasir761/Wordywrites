...
//   return (
// <div className="relative px-6 pt-8 pb-10 bg-white dark:bg-background transition-colors">
//       {/* Glow Background Accent */}
//       <div className="absolute inset-0 z-[-1] bg-gradient-to-br from-ai-accent/10 dark:from-ai-accent/20 via-transparent to-transparent rounded-2xl pointer-events-none" />
...
export default function DashboardHeroBanner() {
  ...
  return (
    <div className="relative px-6 pt-8 pb-10">
      {/* Glow Background Accent */}
      <div className="absolute inset-0 z-[-1] bg-gradient-to-br from-ai-accent/10 dark:from-ai-accent/25 via-transparent to-transparent rounded-2xl pointer-events-none" />
