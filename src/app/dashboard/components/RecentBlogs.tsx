              ...
              <>
                <div className="overflow-auto max-h-[320px]">
                  <Table className="min-w-[700px]">
                    ...
                    >
                      <TableRow>
                        {["Title", "Date", "Tone", "Word Count", "Actions"].map(
                          (col, i) => (
                            <TableHead
                              key={i}
                              className="
                                text-xs uppercase font-heading tracking-wide
                      ...
                      {blogs.map((blog: any, i: number) => (
                        <motion.tr
                          ...
                          className="
                            ...
                            hover:bg-ai-accent/5 hover:border-ai-accent/30
                          "
                        >
                          ...
                          <TableCell>
                            <Badge
                              className="
                                text-[10px] font-heading px-2 py-0.5
                                border border-ai-accent/30 bg-ai-accent/10 text-ai-accent
                              "
                            >
                              {blog.toneAgent?.tone || "Neutral"}
                            </Badge>
                ...
                <div
                  className="
                    flex items-center justify-end gap-2 px-4 py-4
