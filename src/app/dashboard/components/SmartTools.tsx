...
//                 `
//                   group relative rounded-2xl p-5 flex flex-col gap-3
//                   bg-card/70 dark:bg-card/30 backdrop-blur-xl
//                   border border-border/60
//                   shadow-[0_0_25px_-10px_rgba(0,0,0,0.25)]
//                   transition-all duration-300
//                 `,
...
//               {/* Coming soon badge only if unavailable */}
//               {!item.available && (
//                 <div className="absolute top-3 right-3 inline-flex items-center gap-1 rounded-md bg-muted/30 dark:bg-muted/20 border border-border px-2 py-0.5 text-[10px] font-medium text-muted-foreground">
//                   Coming soon
//                 </div>
//               )}

//               {/* Tool icon */}
//               <div className="w-11 h-11 rounded-lg bg-secondary/40 dark:bg-secondary/20 border border-border flex items-center justify-center p-2">
//                 <img src={item.logo} alt={item.name} className="w-full h-full object-contain" />
//               </div>
